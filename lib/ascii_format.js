...
buster.format.ascii = (function () {
    ...
    ascii.array = function (array) {
        var pieces = [];

        for (var i = 0, l = array.length; i < l; ++i) {
            pieces.push(ascii(array[i]));
        }

        return "[" + pieces.join(", ") + "]";
    };

    ascii.object = function (object, indent, processed) {
        processed = processed || [];
        ...
        for (i = 0, l = properties.length; i < l; ++i) {
            ...
            if (typeof obj == "object") {
                str = isCircular(obj, processed) ?
                    "[Circular]" : ascii.object.call(this, obj, indent + 2, processed);
            } else {
                str = ascii(obj);
            }
