...
ascii.array = function(array, processed, delimiters) {
    ...
    for (i = 0; i < l; ++i) {
        pieces.push(ascii(this, array[i], internalProcessed));
    }
...
ascii.object = function(object, processed, indent) {
    ...
    for (i = 0; i < l; ++i) {
        ...
        if (isCircular(obj, internalProcessed)) {
            str = "[Circular]";
        } else {
            str = ascii(this, obj, internalProcessed, internalIndent + 2);
        }
